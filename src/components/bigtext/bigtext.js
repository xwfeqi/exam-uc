...
const Bigtext = () => {
  return (
    <div
      className="relative flex items-center justify-center min-h-screen bg-cover bg-center -mt-24"
      style={{
    ...
    >
      ...
      <div className="relative max-w-4xl px-8 text-white text-center">
        ...
        {/* New button to navigate to the new page */}
        <Link to="/dest-page">
          <button className="mt-8 px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700">
            Go to New Page
          </button>
        </Link>
      </div>
